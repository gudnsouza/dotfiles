...
function M.fn(node)
  ...
  vim.ui.input({ prompt = "Create file ", completion = "file" }, function(new_file_path)
    if not new_file_path then
      return
    end
    new_file_path = containing_folder .. "/" .. new_file_path

    if new_file_path == containing_folder then
      return
    end
